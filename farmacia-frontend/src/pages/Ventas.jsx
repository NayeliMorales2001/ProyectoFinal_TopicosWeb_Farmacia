...
function Ventas() {
    ...
    const cargar = async () => {
        try {
            ...
            // CORREGIDO: Usar la misma estructura que en Pacientes
                ...
                <div className="card-body">
                    <div className="row g-4">
                        ...
                        <div className="col-md-6">
                            ...
                            {pacientes.length === 0 && (
                                <small className="text-warning">⚠️ No se encontraron pacientes</small>
                            )}
                        </div>
                        ...
                        <div className="col-md-6">
                            ...
                            {medicos.length === 0 && (
                                <small className="text-warning">⚠️ No se encontraron médicos</small>
                            )}
                        </div>
